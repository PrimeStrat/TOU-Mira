...
public sealed class HnsMysticDeathNotifModifier(PlayerControl mystic) : TimedModifier
{
    private static readonly Color FlashColor = Palette.CrewmateRoleBlue;

    private ArrowBehaviour? _arrow;
    public override string ModifierName => "Death Notifier";
    public override float Duration => OptionGroupSingleton<HnsMysticOptions>.Instance.MysticArrowDuration;
